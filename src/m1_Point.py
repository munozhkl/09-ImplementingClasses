...
class Point(object):
    ...
    def get_distance_from_start(self):
        distance_from_start = math.sqrt((self.x - self.originalx)**2 + (self.y - self.originaly)**2)
    ...
    def halfway_to(self, p2):
        halfpointx = (p2.x + self.x)/2
        halfpointy = (p2.y + self.y)/2
        halfpoint = Point(halfpointx, halfpointy)
        return halfpoint
